...
import (
	...
	"github.com/eduardosirangelo/go-angular-ai-adaptive-learning/services/assessment-api/internal/api"
...
func main() {
	...
	cfg, err := config.Load("assessment-api")
	if err != nil {
	...
	log.Printf("Assessment API listening on %s", addr)
