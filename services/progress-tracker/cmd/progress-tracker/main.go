...
import (
	...
	"github.com/eduardosirangelo/go-angular-ai-adaptive-learning/services/progress-tracker/internal/api"
...
func main() {
	...
	cfg, err := config.Load("progress-tracker")
	if err != nil {
	...
	log.Printf("Progress Tracker listening on %s", addr)
